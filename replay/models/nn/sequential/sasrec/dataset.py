...
class SasTrainingBatch(NamedTuple):
    """
    Batch of data for training.
    Generated by `SasTrainingDataset`.
    """
...
class SasTrainingDataset(TorchDataset):
    """
    Dataset that generates samples to train Sas-like model
    """
    ...
    def __getitem__(self, index: int) -> SasTrainingBatch:
...
class SasPredictionBatch(NamedTuple):
    """
    Batch of data for model inference.
    Generated by `SasPredictionDataset`.
    """
...
class SasPredictionDataset(TorchDataset):
    """
    Dataset that generates samples to infer Sas-like model
    """
    ...
    def __getitem__(self, index: int) -> SasPredictionBatch:
        query_id, padding_mask, features = self._inner[index]
        return SasPredictionBatch(
            query_id=query_id,
...
class SasValidationBatch(NamedTuple):
    """
    Batch of data for validation.
    Generated by `SasValidationDataset`.
    """
...
class SasValidationDataset(TorchDataset):
    """
    Dataset that generates samples to infer and validate Sas-like model
    """
    ...
    def __getitem__(self, index: int) -> SasValidationBatch:
        query_id, padding_mask, features, ground_truth, train = self._inner[index]
        return SasValidationBatch(
            query_id=query_id,
            padding_mask=padding_mask,
            features=features,
            ground_truth=ground_truth,
